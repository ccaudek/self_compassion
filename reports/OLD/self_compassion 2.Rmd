...
However, the relationship between self-compassion, PTSD, and PTG is still poorly understood [@zhao2020self]. The purpose of the present study is to further examined the relationships between these variables in a sample of rescue workers.
<!-- , with a special attention to the question of the validity of the self-compassion construct.  -->


## Self-compassion, PTSD, and PTG 

Self-compassion is an adaptive coping style which leads individuals to treat themselves with kindness and in a nonjudgmental manner, also in times of stress [@neff2003development]. The role self compassion as a protective factor against PTSD is well established [for a recent review, see @winders2020self]. It has been shown that self-compassion is associated (1) with easing the negative impact of trauma and PTSD symptoms [@janoff1989assumptive], (2) with lower levels of shame, which is a form of internal threat following trauma [@keene2016childhood], (3) with adaptive coping strategies [@seligowski2015relations], (4) with improved emotional regulation [@badour2013trauma], resilience [@seligowski2015relations] and a greater ability to manage distress [@barlow2017trauma], (5) and with feeling interpersonally connected to others [@aspy2017mindfulness], which is a  trauma-resilience factor [@bistricky2017frequency]. 

Post-Traumatic Growth (PTG) has been proposed as a set of positive changes that  follow a traumatic event and lead to changes in self-perception, in interpersonal relationships, and in a reevaluation of one's own view of the world [@tedeschi2004posttraumatic]. It has been shown that self-compassion may lead to PTG by reducing ruminations and depressive symptoms [@nolen2008rethinking], and by providing a more effective coping strategy with stress through reliance on positive cognitive restructuring [@allen2010self]. For example, @wong2017self showed that the relation between the positive component of self-compassion and PTG is mediated by several adaptive cognitive processes such as acceptance, positive reframing and presence of meaning. @chishima2018influence found that stressful events experienced in the previous month tended to be judged as be less threatening and more controllable by high self-compassion participants than by low self-compassion participants.

Only few studies, however, have examined the relation between self-compassion, PTSD, and PTG in samples of rescue workers. @zhao2020self, for example, considered a sample of volunteers from the Chinese Red Cross and found that self-acceptance, a core component of self-compassion, impacted positively PTG and negatively PTSD, with the mediating role of social support. 
...
1. It might inflate the link with psychopathology, given that the relations found between the SCS total scores and other psychological constructs might mainly depend on the RUS component of the SCS [@muris2018good]. But the RUS component of the SCS is strongly associated with symptoms such as anxiety and depression [@muris2017protection] and, once such component is removed from the SCS, the added value of the SC component might be marginal [@muris2019stripping]. 

2.  It is not clear what, if anything, is added by the CS component of the SCS to the nomological network in which self-compassion is situated. @kandler2017old have taken the extreme stance of arguing that the SC construct is redundant because it overlaps with with the personality trait of Neuroticism: Once Neuroticism is controlled, there is no evidence of a specific contribution of positive self-compassion. 

This debate has receiving considerable attention in the recent literature on SC because the questions that have been raised are relevant for therapeutic interventions. In fact, it is of interest to understand whether the association between the treatment effects and the compassionate component of the SCS may be obscured by the common use of the SCS total score [@wadsworth2018examining].
One limit of previous studies, however, is that they have often been performed in student populations, that is, in samples in which PTSD and PTG are only present in mild forms. The purpose of the present study is to evaluate the hypotheses of @muris2019stripping and of @geiger2018self in a sample of rescue workers where we expect to observe greater individual differences in adaptive or maladaptive responses to stress. 
...
Before assessing the relation between the SCS and PTG and IES-R, we examined the factor structure of the SCS [_e.g._, @neff2019examining; @muris2020process; @muris2021non]. 
...
In summary, two measurement models distinguishing between the CS and RUS components met our criteria for at least adequate fit. Their goodness of fit indexes, however, were worse than those of the "holistic" bifactor ESEM models with six specific factors. 


### Latent Profiles Analysis

A further test of the idea that it is useful to distinguish between the CS and RUS components of the SCS was carried out by means of a Latent Profiles Analysis (LPA), which allows to identify underlying latent sub-groups, or profiles, based on common response patterns. Specifically, we asked whether the LPA profiles which emerge from the six dimensions of the SCS can be distinguished in terms of the CS and RUS dimensions. In order to validate the SC/RUS distinction, we then related the obtained LPA profiles to the adaptive and maladaptive responses to stress (_i.e._, to the PTG and IES-R scores). 
...
The resulting HPD 95% intervals not including the zero point were then examined in order to contrast two opposite hypotheses: (a) the direction of the contrasts was consistent with a difference in CS levels for the PTG responses and with a difference in RUS levels for the IES-R resposes, versus (b) the direction of the contrasts was consistent with a difference in RUS levels for the PTG responses and with a difference in CS levels for the IES-R resposes. 
...
If the "holistic" hypothesis about the structure of the SCS is correct, then these two hypotheses should be equivalent.
...
### Self-compassion in rescue-workers and non-rescue-workers

We asked whether our sample of rescue-workers developed a different level of self-compassion than a comparable sample of volunteers not directly acting in the capacity of first-time responders (_n_ = 138). 
...
We used SEM to test several mediation models. Model 6 placed CS and RUS as mediators between Coping, Perceived social support, and Neuroticism (exogeneous variables), and post-traumatic growth and post-traumatic stress (endogeneous variables). Model-fitting parameters were indicative of good overall
...
We found no evidence of a direct effect of Coping on neither PTG nor on PTSS.
Conversely, we found evidence of an indirect effect of Coping on PTG, with a total effect of 0.238, 95% CI = [0.127, 0.355]. This suggests a fully mediated effect of Coping on PTG. Instead, no evidence was found of a mediated effect of Coping on PTSS, 95% CI = [-0.026, 0.219].

We found no evidence of a direct effect of Perceived social support on PTSS, nor evidence of an indirect effect, 95% CI = [-0.057, 0.037]. Instead, we found evidence of a direct effect of perceived social support on PTG, but no evidence of an indirect effect, 95% CI = [-0.023, 0.031]; for the total effect, 95% CI = [0.085, 0.282].

Finally, we found no evidence of a direct effect of Neuroticism on PTSS, but we found evidence of an indirect effect, 95% CI = [0.283, 0.755], with a total effect of 0.571, 95% CI = [0.451, 0.711]. This suggests that the effect of Neuroticism on PTSS is fully mediated. Conversely, we found no evidence of a direct effect of Neuroticism on PTG, nor evidence of an indirect effect of Neuroticism on PTG, with a total effect of 0.032, 95% CI = [-0.184, 0.232].
...
- The dichotomy between CS and RUS was confirmed when considering the SCS profiles identified by a LPA: We found that CS subscales were associated with group differences in PTG, whereas RUS subscales were associated with group differences in IES-R. 
...
- In the SEM analyses, we found that CS offered additional explanatory power to what was offered by RUS and, correspondingly, RUS offered additional explanatory power to what was offered by CS. This is an important result that relates to a nevralgic point of the research on the construct validity of the SCS. This results suggest that the CS and RUS component may have functionally different properties in individuals who must directly confront traumatic events (such as rescue-workers) and in individuals with lower levels of PTSS and PTG [e.g., @muris2019stripping]. 

- We did not find that Neuroticism overlaps with RUS [e.g., @geiger2018self; @kandler2017old]. In fact, we found the opposite result: In a SEM model with both RUS and Neuroticism, these two variables played separate roles. Again, this result may differ from what reported previously because self-compassion and Neuroticism may have different properties in individuals exposed to trauma and in college students.


## Conclusion {#conclusion}

The present results are consistent with previous reports indicating that a two-dimensional structure of the SCS may have a greater significance than the unidimensional structure when studying psychopathological symptoms [@montero2016burnout] or, as in the present case, when studying the psychological well-being of workers in "helping" professions that experience vicarious trauma and/or secondary traumatic stress. Specifically, we found that CS was more strongly associated with PTG, while RUS was more strongly associated with (reduced) PTSS. Interestingly, we also found that first-time responders who were more likely to be directly exposed to traumatic events manifested great levels of RUS than comparable volunteers  less likely to be directly exposed to traumatic events; correspondingly, first-time responders manifested lower levels of CS than non-first-time responders. We interpret these results as a cognitive shift deriving from compassion fatigue, away from a proactive positive attitude and towards a more difensive attitude in relation with the self. Such a "recalibration of self-compassion" is obscured when only the SCS total score is considered. 
